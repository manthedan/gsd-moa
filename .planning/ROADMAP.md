...
- [ ] **Phase 1: Package, Config, and Policy Foundation** - Create the Pi package skeleton, config schema, deterministic router, context sanitizer, and foundational tests.
...
Plans:
- [ ] 01-01: Create package skeleton, extension entry, config schema, and defaults.
- [ ] 01-02: Implement deterministic mode policy, marker stripping, and recursion/config guards.
- [ ] 01-03: Implement reference-safe context sanitizer and foundational unit tests.
...
|-------|----------------|--------|-----------|
| 1. Package, Config, and Policy Foundation | 0/3 | Not started | - |
