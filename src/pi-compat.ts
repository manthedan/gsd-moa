...
export function streamSimple<TApi extends Api>(
  ...
  void (async () => {
    try {
      ...
      const inner = rawStreamSimple(model as OmpTypes.Model<TApi>, normalizeContext(context), options);
...
export async function completeSimple<TApi extends Api>(
  ...
  return rawCompleteSimple(model as OmpTypes.Model<TApi>, normalizeContext(context), options);
}

function normalizeContext(context: Context): OmpTypes.Context {
  return {
    ...context,
